...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # 56,56,64 -> 28,28,128
        self.layer2 = self._make_layer(block, 50, layers[1], stride=2,
                                       dilate=replace_stride_with_dilation[0])

        # 28,28,128 -> 14,14,256
        self.layer3 = self._make_layer(block, 125, layers[2], stride=2,
                                       dilate=replace_stride_with_dilation[1])

        # 14,14,256 -> 7,7,512
        self.layer4 = self._make_layer(block, 250, layers[3], stride=2,
