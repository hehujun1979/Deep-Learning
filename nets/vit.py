...
class PatchEmbed(nn.Module):
    def __init__(self, input_shape=[500, 500], patch_size=16, in_chans=12, num_features=768, norm_layer=None, flatten=True):
        super().__init__()
...
class VisionTransformer(nn.Module):
    def __init__(
            self, input_shape=[500, 500], patch_size=16, in_chans=12, num_classes=1000, num_features=768,
        ...
        num_patches         = (500// patch_size) * (500 // patch_size)
        self.num_features   = num_features
        self.new_feature_shape = [int(input_shape[0] // patch_size), int(input_shape[1] // patch_size)]
        self.old_feature_shape = [int(500 // patch_size), int(500 // patch_size)]
...
def vit(input_shape=[500, 500], pretrained=False, num_classes=1000):
